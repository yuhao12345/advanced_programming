...
int main(int argc, char *argv[]) {
    ...
    //extract dictionary from BSTree and save it to string array char** dict
    char** dict=malloc(500*sizeof(char*));
    int size_dict=0;
    extract_dict_from_Tree(root, length_threshold, freq_threshold, dict, &size_dict);
